...
export const metadata: Metadata = constructMetadata({
  ...
  description:
    'Get your Regulated Agent (RA) Licence from BCAS with expert professional support. Fast, transparent, and 100% government-compliant RA licence registration across India.',
...
export default function RALicencePage() {
  return (
    <div className="bg-slate-50 min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-12 items-start">
            <div className="text-white">
              ...
              <p className="text-white/75 text-lg leading-relaxed max-w-lg mb-4">
              ...
              <div className="flex flex-wrap gap-3">
                {['BCAS Approved Process', '30-Day Turnaround', 'Expert Professional', 'Pan-India Service'].map(tag => (
                  <span
                    key={tag}
      ...
      <section
        className="py-8 bg-white border-b border-slate-100"
