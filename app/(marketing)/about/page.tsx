  ...
  return (
    <div className="bg-slate-50 min-h-screen py-10">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-extrabold text-slate-900 mb-4 text-center font-serif">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12 prose prose-slate max-w-none">
          ...
          <p className="text-lg leading-relaxed text-slate-600 mb-6">
            Aj Accounting-Group is an ISO 9001:2015 Certified and approved by Government of India. We are providing professional accounting services. We encompass a group of professionals that strive to provide highly customized and efficient deliverables on professional services, CFO services, and Account Outsourcing services and Certification ( IATA, RA&apos;s licence, ISO Certification etc) services.
          </p>
          ...
          <h3 className="text-xl font-bold text-slate-800 mb-4 mt-4">Locations</h3>
